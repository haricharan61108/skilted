  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success("Login Successful!", {
        description: data.message || "Welcome back! Redirecting to dashboard...",
        duration: 2000,
      })

      // Show success dialog
      showDialog("success", "Login Successful!", data.message || "Welcome back! Redirecting to dashboard...")
        ...
        <Card className="border-0 shadow-2xl bg-white/80 backdrop-blur-sm">
          <CardHeader className="text-center pb-4">
            ...
            <CardDescription className="text-gray-600">
              Sign in to your admin account to manage your marketplace
            </CardDescription>
          </CardHeader>
